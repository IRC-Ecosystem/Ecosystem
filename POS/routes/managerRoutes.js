...
router.post("/manager/payments/:id/refund", requireRole("manager"), managerController.refundPayment);
router.post("/manager/transactions/:id/void", requireRole("manager"), managerController.voidTransaction);
router.get("/manager/audit-logs", requireRole("manager"), managerController.auditLogs);
